...
action_8 (9) = happyShift action_9
...
happyReduction_3 (_ `HappyStk`
	(HappyTerminal (TokenRegexp happy_var_3)) `HappyStk`
	_ `HappyStk`
...
happyNewToken action sts stk (tk:tks) =
	...
	case tk of {
	TokenName happy_dollar_dollar -> cont 6;
	TokenRegexp happy_dollar_dollar -> cont 7;
	TokenEq -> cont 8;
	TokenSemicolon -> cont 9;
	_ -> happyError' (tk:tks)
	}
...
parse_regexp_defs tks = happyRunIdentity happySomeParser where
